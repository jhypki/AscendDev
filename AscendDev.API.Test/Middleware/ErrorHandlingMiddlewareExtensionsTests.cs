...
namespace AscendDev.API.Test.Middleware
{
    ...
    {
        [Test]
        public void UseErrorHandling_RegistersMiddleware()
        {
            ...
            var result = ErrorHandlingMiddlewareExtensions.UseErrorHandling(appBuilder);
        ...
        // Simple test double for IApplicationBuilder
